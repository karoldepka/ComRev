  ...
  return (
    ...
    >
      ...
      <TouchableOpacity
        ...
        accessibilityLabel="View the ComRev project on GitHub"
      >
        <Text style={[styles.ghButtonText, { color: c.tint }]}>
          View on GitHub ↗
        </Text>
      </TouchableOpacity>
    </ParallaxScrollView>
...
function InfoRow({
  ...
  return (
    <View style={styles.row}>
      <Text style={[styles.rowLabel, { color: c.text, opacity: 0.55 }]}>
        {label}
      </Text>
      <Text
        style={[
          styles.rowValue,
          { color: c.text, fontFamily: mono ? 'monospace' : undefined },
        ]}
      >
        {value}
      </Text>
