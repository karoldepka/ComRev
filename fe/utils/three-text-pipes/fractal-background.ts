...
export const SCHEME_STOPS: Record<string, number[]> = {
  ...
  aurora:      [0,0.04,0,0.22, 0.3,0,0.75,0.35, 0.65,0,0.88,0.78, 1,0.72,0,0.82],
  candy:       [0,1,0.08,0.55, 0.35,1,0.92,0.06, 0.65,0,0.88,1, 1,0.94,0,0.94],
  gold:        [0,0.18,0.04,0, 0.35,0.72,0.38,0, 0.7,1,0.82,0.08, 1,1,0.98,0.65],
  cosmic:      [0,0.04,0,0.12, 0.28,0.28,0,0.62, 0.62,0.94,0.18,0.82, 1,0.96,0.88,1],
  tropical:    [0,0,0.35,0.48, 0.32,0,0.86,0.78, 0.65,1,0.55,0.04, 1,1,0.08,0.52],
  cherry:      [0,0.06,0,0.08, 0.3,0.55,0,0.22, 0.65,0.96,0.12,0.38, 1,1,0.75,0.78],
  toxic:       [0,0,0.08,0, 0.3,0.18,0.78,0, 0.6,0.78,1,0.04, 1,0.94,1,0.55],
  midnight:    [0,0,0,0.08, 0.3,0.04,0.08,0.48, 0.65,0.24,0,0.82, 1,0.82,0.35,1],
  ember:       [0,0.08,0,0, 0.25,0.62,0,0.08, 0.55,1,0.35,0, 0.8,1,0.82,0.22, 1,1,1,0.88],
};
